  ...
  <div class="row">
    <div class="col-md-12 card">    
      ...
      <el-dialog
        ...
        <div class="row">
        <div class="col-sm-11">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm"  label-position='left' label-width="180px" class="demo-ruleForm">
        ...
        <el-input  type="number" v-model="ruleForm.qtetotal" ></el-input>
        </el-form-item>
        <el-form-item label="Quantité Disponible" class="labellef" prop="qtedispo"  >
        <el-input type="number"  v-model="ruleForm.qtedispo" ></el-input>
        </el-form-item>   
      ...
      <el-dialog
        ...
        <div class="row">
        <div class="col-sm-11">
        <el-form :model="materfac" :rules="rules" ref="materfac" label-width="180px" label-position='left' class="demo-ruleForm">
        <el-form-item  label="Matériel"  prop="materiel"  >
        <el-input  v-model="materfac.materiel" ></el-input>
        </el-form-item>
        <el-form-item label="Quantité Totale" class="labellef" prop="qtetotal">
        <el-input  type="number" v-model="materfac.qtetotal" ></el-input>
        </el-form-item>
        <el-form-item label="Quantité Disponible" class="labellef" prop="qtedisponib" >
        <el-input type="number"  v-model="materfac.qtedisponib" ></el-input>
        </el-form-item>   
    ...
    data () {
      var validateQte = (rule, value, callback) => {
        ...
        setTimeout(() => {
            ...
            else if (value > this.ruleForm.qtetotal) {
            callback(new Error('la quantité Disponible est Supirieur au Quantité Totale '));
            } 
            else {
                  callback();
                }
      ...
      var validateTotale = (rule, value, callback) => {
        ...
        setTimeout(() => {
            ...
            else if (value < this.materfac.qtedisponib) {
            callback(new Error('la quantité Totale est inférieur au Quantité Totale '));
            } 
            else {
                  callback();
                }
    ...
    methods: {
      ...
      ajoutMatriel(){
        ...
        var Materiel = {
            ...
            qteDisponible:this.ruleForm.qtedispo
        }
      ...
      editMatriel(){
        ...
        var Materiel = {
            ...
            qteDisponible:this.materfac.qtedisponib
        }
        http.put("MaterielFaculter/create",Materiel)
        .then(response => {
      ...
      handleEdit (index, row) {
        ...
        this.materfac.qtedisponib=row.qteDisponible
      },
