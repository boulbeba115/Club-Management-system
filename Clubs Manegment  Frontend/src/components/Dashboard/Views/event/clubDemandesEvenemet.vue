  ...
  <div class="row">
    <div class="col-md-12 card">
      ...
      <div class="card-content row">
        <div class="col-sm-6">
            <label>
              <input type="search" class="form-control input-sm" placeholder="Recherche" v-model="searchQuery" aria-controls="datatables">
            </label>
        </div>
        <div class="col-sm-6">
          ...
          <el-table class="table-striped"
            ...
            <el-table-column
              ...
              <template slot-scope="props">
                  ...
                  <a disabled v-if="!props.row.accepterEvent" type="button" class=" btn  btn-fill  btn-xs  btn-danger">interdie</a>
                  <template v-else>
                  <button v-if="!props.row.approuvEvent"  class="btn btn-icon btn-success" @click="creeEvent(props.row)">
                    <i class="ti-check"></i>
                  </button>  
                  <a v-else class="btn btn-xs btn-fill btn-success">Approuver</a>
                  </template>
...
/* eslint-disable */
  ...
  export default {
    ...
    return
    http.get('demandecreationclub/listbyClub/'+clubname)
    ...
    creeEvent(demandeEv){
      ...
      swal({
        ...
        self.$router.push('/demandeEvenement/evenementdeclub')
      })
    },
